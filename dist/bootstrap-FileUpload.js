	...
	var methods = {
		...
		addFile: function (el, event) {
			...
			for (var i = 0; i < length; i++) {
                ...
                if (size.toFixed(2) < instance[el].options.minSize) {
                    window.alert('The file size for "' + file.name + '" is too small! Minimum supported file size is ' + instance[el].options.minSize + 'MB and the size of the file is ' + size + 'MB');
